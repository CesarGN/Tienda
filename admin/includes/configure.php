<?php
  ...
  define('DIR_FS_DOCUMENT_ROOT', 'C:/xampp/htdocs/Oscommerce/catalog/');
  define('DIR_WS_ADMIN', '/OsCommerce/catalog/admin/');
  define('DIR_FS_ADMIN', 'C:/xampp/htdocs/Oscommerce/catalog/admin/');
  define('DIR_WS_CATALOG', '/OsCommerce/catalog/');
  define('DIR_FS_CATALOG', 'C:/xampp/htdocs/Oscommerce/catalog/');
